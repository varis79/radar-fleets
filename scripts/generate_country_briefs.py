...
"ecuador": {
    ...
    "slug": "ecuador",
    "hreflang": "es-419",
    "url": "https://thefleetradar.com/mercados/ecuador/",
    "accent_a": "#ffd200",
    "accent_b": "#c8102e",
    "grad_a": "rgba(255,210,0,0.18)",
    "grad_b": "rgba(200,16,46,0.14)",
    "topbar_meta": "Mercado · Ecuador 🇪🇨",
    "hreflang_code": "es-419",
    "meta_desc": "Panorama de flotas en Ecuador 2026: ANT, MTOP, focalización del subsidio al diésel, Petroecuador, corredor Guayaquil-Quito y sectores bananero, atunero y petrolero.",
    "og_desc": "Regulación, players y cifras clave del mercado de gestión de flotas en Ecuador 2026.",
    "schema_desc": "Panorama editorial del mercado de gestión de flotas en Ecuador 2026: ANT, dolarización, subsidio al diésel, Petroecuador y players activos.",
    "deck": "Ecuador opera bajo dolarización desde 2000, lo que estabiliza los costos pero deja al sector flotero expuesto a la política de subsidios de combustible. La focalización del subsidio al diésel impulsada en 2024-2025 cambió la ecuación operativa del transporte de carga. El corredor Guayaquil-Quito concentra la actividad logística y el puerto de Guayaquil canaliza el comercio bananero y atunero de exportación.",
    "updated": "24 de mayo de 2026",
    "intro": """<p>Ecuador combina dos rasgos que lo diferencian en LatAm: economía dolarizada desde el año 2000 y un sector de transporte de carga históricamente dependiente del subsidio al diésel. La focalización progresiva de ese subsidio durante 2024-2025 está rebalanceando los costos operativos del sector flotero y empuja la conversación hacia eficiencia y control de gasto.</p>
    <p>El eje Guayaquil-Quito concentra la actividad logística del país. El Puerto de Guayaquil es el principal puerto del Pacífico ecuatorial: por allí salen las exportaciones de banano (Ecuador es el mayor exportador del mundo), atún en conserva y camarón. La flota refrigerada de exportación tiene estándares exigentes para los mercados europeo y estadounidense.</p>
    <p>La ANT (Agencia Nacional de Tránsito) regula matrícula vehicular, licencias y control de transporte terrestre. El MTOP (Ministerio de Transporte y Obras Públicas) define la política sectorial y la inversión en infraestructura vial, con foco en los corredores costa-sierra.</p>""",
    "regulacion": [
        ("Activo", "ANT — Agencia Nacional de Tránsito",
         "Regula matrícula vehicular, licencias de conducir profesionales (tipos C, D, E para carga y pasajeros) y revisión técnica vehicular anual obligatoria. La ANT coordina con los GADs municipales la operación de centros de revisión técnica en las principales ciudades."),
        ("Activo", "MTOP — Ministerio de Transporte y Obras Públicas",
         "Define la política sectorial del transporte terrestre, marítimo y aéreo. Gestiona los corredores viales nacionales —Panamericana, Vía a la Costa, Troncal Amazónica— y supervisa concesiones viales. Publica estadísticas del parque automotor y la red vial."),
        ("Activo", "Focalización del subsidio al diésel y extra (2024-2025)",
         "El gobierno ecuatoriano avanzó en la focalización del subsidio a los combustibles. El diésel y la gasolina extra dejaron de tener precio fijo subsidiado para uso general, con esquemas de compensación para transporte público y carga. El cambio impacta directamente la estructura de costos operativos del sector flotero."),
        ("Activo", "Petroecuador — operador estatal de hidrocarburos",
         "EP Petroecuador es la empresa pública responsable de la cadena de hidrocarburos: refinación, transporte y comercialización mayorista. Las redes minoristas (Primax, Terpel, PDV, Petrocomercial) se abastecen del producto Petroecuador. La política de precios sigue siendo el principal vector de cambio del sector."),
        ("soon", "En desarrollo — Modernización de la normativa de transporte pesado",
         "La ANT y el MTOP trabajan en actualizar requisitos técnicos para vehículos de carga (pesos, dimensiones, emisiones) alineados con estándares regionales. La adopción de telemetría sigue siendo voluntaria y concentrada en flotas formales medianas y grandes."),
    ],
    "players": {
        "Combustible y energía": [
            "Primax · principal red de estaciones privadas con tarjeta empresarial",
            "Terpel · red con presencia en corredores principales",
            "PDV · marca de PDVSA Ecuador con red minorista",
            "Petroecuador · operador estatal y abastecedor mayorista",
        ],
        "Telemática y GPS": [
            "Geotab · entrada gradual vía distribuidores locales",
            "Samsara · perfil enterprise en flotas grandes",
            "Loginet · proveedor local con cobertura nacional",
            "Movestar · solución ecuatoriana para flotas medianas y PYME",
        ],
        "Renting y servicios": [
            "Casabaca · concesionario Toyota con servicios de flota",
            "Automotores y Anexos (AyASA) · Nissan, presencia en flota corporativa",
            "LeasePlan · renting corporativo multinacional",
        ],
        "Fabricantes relevantes": [
            "Toyota · Hilux dominante en flotas de campo y agroindustria",
            "Chevrolet · D-Max y NPR en carga liviana y media",
            "Hino · camiones de distribución urbana e interprovincial",
            "Volvo · tractocamiones en corredor pesado Guayaquil-Quito",
            "JAC y Foton · entrada china en segmento precio",
        ],
    },
    "fleet_types": [
        ("Exportación bananera refrigerada", "Ecuador es el mayor exportador mundial de banano. Flotas refrigeradas conectan plantaciones de Los Ríos, Guayas y El Oro con el Puerto de Guayaquil. Cadena de frío crítica para los mercados europeo y ruso."),
        ("Atunero y pesquero", "Manta como principal puerto pesquero del Pacífico ecuatorial. Flotas de transporte de atún en conserva hacia plantas procesadoras y centros de exportación. Exigencias de trazabilidad para certificaciones internacionales."),
        ("Petrolero — Esmeraldas y Amazonía", "Refinería de Esmeraldas y operaciones de extracción en la Amazonía (Sucumbíos, Orellana). Flotas de servicio de pozos y transporte de derivados con altos estándares de seguridad."),
        ("Corredor Guayaquil-Quito", "Eje logístico principal del país. Tractocamiones de larga distancia entre la costa y la sierra, con paso por Riobamba y la cordillera. Demanda creciente de telemetría por la exigencia del recorrido andino."),
        ("Distribución urbana", "Guayaquil, Quito, Cuenca y Manta como mercados de distribución urbana. Cadenas de supermercados (Supermaxi, Mi Comisariato), consumo masivo y delivery con flotas propias y tercerizadas."),
    ],
    "figures": [
        ("~2,5M", "vehículos en el parque automotor total del Ecuador, según cifras de la ANT", "ANT · 2025"),
        ("#1 mundial", "Ecuador es el mayor exportador mundial de banano, lo que sostiene la demanda de flota refrigerada de exportación", "AEBE · 2025"),
        ("~60%", "del comercio exterior ecuatoriano se canaliza por el Puerto de Guayaquil, eje del corredor logístico principal", "Autoridad Portuaria de Guayaquil · 2025"),
        ("Dolarización", "Ecuador opera con dólar estadounidense desde el año 2000, lo que estabiliza precios pero deja al sector expuesto a la política de subsidios", "BCE · 2026"),
    ],
    "related_topics": [
        ("/temas/control-gasto-flota-mexico-2026/", "Tema · Referencia", "Control de gasto en flota", "Metodologías de control de costos aplicables tras la focalización del subsidio al diésel."),
        ("/mercados/latam/", "Mercado · Regional", "Flotas en LatAm · Panorama 2026", "Tendencias transversales de la región que impactan a Ecuador."),
        ("/temas/tarjetas-flota-mexico-2026/", "Tema · Combustible", "Tarjetas de flota y combustible", "Control de gasto en combustible con esquemas multi-marca."),
    ],
    "editions": [
        ("/magazines/2026-04-20-radar-fleet-by-pulpo.html", "Nº 3 · Peajes por km, electrificación LatAm y operador asesinado", "20 abril 2026"),
        ("/magazines/2026-05-11-radar-fleet-by-pulpo.html", "Nº 7 · Tendencias de gestión de flotas", "11 mayo 2026"),
    ],
    "cta_heading": "Pulpo Hub — control de gasto en mercados que cambian de política",
    "cta_body": "Tras la focalización del subsidio al diésel en Ecuador, el control de gasto operativo se vuelve crítico. Pulpo Hub ofrece visibilidad en tiempo real de combustible, mantenimiento y operación. El equipo puede evaluar adaptación para flotas ecuatorianas.",
    "sources": [
        ("ANT — Agencia Nacional de Tránsito del Ecuador", "https://www.ant.gob.ec/", "Registro de vehículos, licencias y normativa de transporte terrestre"),
        ("MTOP — Ministerio de Transporte y Obras Públicas", "https://www.obraspublicas.gob.ec/", "Política sectorial, infraestructura vial y estadísticas del transporte"),
        ("EP Petroecuador", "https://www.eppetroecuador.ec/", "Operador estatal de hidrocarburos: refinación, transporte y comercialización"),
        ("BCE — Banco Central del Ecuador", "https://www.bce.fin.ec/", "Estadísticas económicas, balanza comercial y datos del sector transporte"),
        ("AEBE — Asociación de Exportadores de Banano del Ecuador", "https://www.aebe.com.ec/", "Datos del sector bananero, principal demandante de flota refrigerada"),
        ("Autoridad Portuaria de Guayaquil", "https://www.apg.gob.ec/", "Estadísticas de carga del principal puerto del país"),
    ],
},
...
"uruguay": {
    ...
    "slug": "uruguay",
    "hreflang": "es-419",
    "url": "https://thefleetradar.com/mercados/uruguay/",
    "accent_a": "#0038a8",
    "accent_b": "#fcd116",
    "grad_a": "rgba(0,56,168,0.18)",
    "grad_b": "rgba(252,209,22,0.14)",
    "topbar_meta": "Mercado · Uruguay 🇺🇾",
    "hreflang_code": "es-419",
    "meta_desc": "Panorama de flotas en Uruguay 2026: MTOP, SUCIVE, monopolio ANCAP, tacógrafo obligatorio, sector agroexportador, forestal (UPM) y corredor Montevideo-Punta del Este.",
    "og_desc": "Regulación, players y cifras clave del mercado de gestión de flotas en Uruguay 2026.",
    "schema_desc": "Panorama editorial del mercado de gestión de flotas en Uruguay 2026: MTOP, SUCIVE, ANCAP, sectores agroexportador y forestal.",
    "deck": "Uruguay tiene un mercado de flotas pequeño pero entre los más profesionalizados de LatAm: tacógrafo obligatorio en carga, sistema unificado de patentes (SUCIVE) y monopolio estatal de combustibles (ANCAP) que define la estructura de precios. El sector forestal —liderado por la operación de UPM— y el agroexportador (soja, carne, lechería) sostienen la demanda de flota pesada.",
    "updated": "24 de mayo de 2026",
    "intro": """<p>Uruguay opera un mercado de flotas pequeño en escala pero con un grado de formalidad y profesionalización entre los más altos de LatAm. El parque vehicular ronda los 2 millones de unidades, con una densidad alta para una población de 3,4 millones de habitantes. La concentración geográfica —el 40% de la población vive en el área metropolitana de Montevideo— simplifica la logística respecto a otros mercados regionales.</p>
    <p>El sector se apoya en tres pilares regulatorios: el MTOP (Ministerio de Transporte y Obras Públicas) define la política sectorial; el SUCIVE (Sistema Único de Cobro de Ingresos Vehiculares) unifica el cobro de patentes a nivel nacional desde 2012; y ANCAP mantiene el monopolio de la importación y refinación de combustibles, lo que ofrece estabilidad de precios pero limita la competencia en el segmento mayorista.</p>
    <p>El sector forestal —con UPM operando la mayor planta de celulosa del país en Paso de los Toros— y el agroexportador (soja, carne bovina, lácteos) generan la mayor demanda de flota pesada. El puerto de Montevideo es el eje exportador del Río de la Plata para Uruguay y para carga en tránsito de Paraguay y Bolivia.</p>""",
    "regulacion": [
        ("Activo", "MTOP — Ministerio de Transporte y Obras Públicas",
         "Define la política sectorial del transporte terrestre, marítimo, fluvial y aéreo. Regula la habilitación de empresas de transporte de carga y pasajeros mediante la Dirección Nacional de Transporte. Supervisa la red vial nacional y las concesiones de corredores principales."),
        ("Activo", "SUCIVE — Sistema Único de Cobro de Ingresos Vehiculares",
         "Desde 2012 unifica el cobro de la patente de rodados (impuesto de patente) en todo el territorio nacional, eliminando las diferencias entre departamentos que generaban migración tributaria. Es referencia regional en simplificación administrativa vehicular."),
        ("Activo", "Tacógrafo obligatorio para transporte de carga",
         "Uruguay exige tacógrafo en vehículos de carga superior a determinado tonelaje, con control en ruta por parte de la Dirección Nacional de Transporte. La penetración real es alta en el sector formal, lo que ubica al país por encima del promedio LatAm en cumplimiento de horas de conducción."),
        ("Activo", "ANCAP — Monopolio de combustibles",
         "Administración Nacional de Combustibles, Alcohol y Portland (ANCAP) mantiene el monopolio estatal de la importación, refinación y comercialización mayorista de combustibles. La red minorista opera bajo las marcas DUCSA (filial ANCAP) y Petrobras / Axion. Precios regulados por el Poder Ejecutivo."),
        ("Activo", "DGI — Dirección General Impositiva y facturación electrónica",
         "Uruguay tiene un régimen de comprobantes fiscales electrónicos (CFE) consolidado. Las flotas deben emitir y recibir CFE para todos los servicios de transporte y combustible, integrándolos con sus sistemas de gestión."),
    ],
    "players": {
        "Combustible y energía": [
            "DUCSA · filial minorista de ANCAP, principal red de estaciones",
            "Petrobras · presencia en corredores principales con red de servicio",
            "Axion (anterior Esso) · operador internacional con tarjeta flota",
            "ANCAP · monopolio mayorista de importación y refinación",
        ],
        "Telemática y GPS": [
            "Geotab · presencia en flotas grandes y operaciones forestales",
            "Samsara · perfil enterprise con entrada gradual",
            "Pósitron · solución local con base en Montevideo",
            "Tracksat · proveedor regional con cobertura uruguaya",
        ],
        "Renting y servicios": [
            "LeasePlan · renting corporativo multinacional",
            "Santander Consumer · financiamiento de flota",
            "Sevel · concesionarios Fiat / RAM con servicios de flota",
        ],
        "Fabricantes relevantes": [
            "Chevrolet · S10 y NPR en carga liviana y media",
            "Volkswagen · Amarok y línea Constellation en carga",
            "Mercedes-Benz · Sprinter en distribución y Actros en carga pesada",
            "Scania · tractocamiones en operaciones forestales y exportación",
            "Volvo · presencia en transporte pesado de larga distancia",
        ],
    },
    "fleet_types": [
        ("Forestal — UPM y celulosa", "UPM opera la mayor planta de celulosa del país en Paso de los Toros (operativa desde 2023). Flotas de Scania y Volvo de gran tonelaje transportan madera y celulosa entre plantaciones, planta y el puerto de Montevideo. Estándares internacionales de seguridad y mantenimiento."),
        ("Agroexportador — soja y granos", "Litoral oeste (Soriano, Río Negro, Paysandú, Salto) como principal zona sojera. Camiones graneleros conectan campos con puertos fluviales del Río Uruguay y con el puerto de Nueva Palmira. Estacionalidad marcada por la cosecha."),
        ("Carne bovina y lechería", "Uruguay exporta carne premium a más de 100 mercados (UE, China, EE.UU.). Flotas frigoríficas y de transporte de hacienda en pie. La cuenca lechera (Florida, San José, Colonia) demanda flota de recolección diaria."),
        ("Corredor Montevideo-Punta del Este", "Eje turístico y de servicios con alta concentración estacional. Flotas de transporte de pasajeros (CUTCSA, COPSA), distribución a hoteles y logística de eventos en temporada alta."),
        ("Puerto de Montevideo y carga en tránsito", "El puerto opera carga propia y en tránsito hacia Paraguay y Bolivia. Flotas de carga contenerizada operan entre puerto, zonas francas y terminales interiores. Densidad alta para la escala del mercado."),
    ],
    "figures": [
        ("~2M", "vehículos en el parque automotor de Uruguay, con alta densidad por habitante para la escala regional", "Unasev / SUCIVE · 2025"),
        ("~10%", "participación del sector transporte y logística en el PIB de Uruguay", "BCU · 2025"),
        ("#1 plantación", "UPM Paso de los Toros es la mayor planta de celulosa de Uruguay (operativa desde 2023) y de las mayores de Sudamérica, eje de demanda forestal de flota pesada", "UPM · 2025"),
        (">100", "mercados a los que Uruguay exporta carne bovina, lo que sostiene la demanda de flota frigorífica de exportación", "INAC · 2025"),
    ],
    "related_topics": [
        ("/temas/telematica-flotas-mexico-2026/", "Tema · Referencia", "Telemática para flotas · Referencia LatAm", "Players y benchmarks aplicables al mercado uruguayo profesional."),
        ("/mercados/latam/", "Mercado · Regional", "Flotas en LatAm · Panorama 2026", "Tendencias transversales que impactan al Cono Sur."),
        ("/temas/compliance-flotas-mexico-2026/", "Tema · Regulación", "Cumplimiento normativo en flotas", "Metodologías de compliance aplicables al marco uruguayo (tacógrafo, CFE, SUCIVE)."),
    ],
    "editions": [
        ("/magazines/2026-04-20-radar-fleet-by-pulpo.html", "Nº 3 · Flota pesada y tendencias LatAm", "20 abril 2026"),
        ("/magazines/2026-05-04-radar-fleet-by-pulpo.html", "Nº 5 · Regulación, electrificación y gestión", "4 mayo 2026"),
    ],
    "cta_heading": "Pulpo Hub — plataforma para mercados profesionalizados",
    "cta_body": "Uruguay tiene un mercado pequeño pero exigente en formalidad. Pulpo Hub se integra con esquemas de facturación electrónica y control de gasto. El equipo puede evaluar adaptación para flotas uruguayas de exportación y servicios.",
    "sources": [
        ("MTOP — Ministerio de Transporte y Obras Públicas", "https://www.gub.uy/ministerio-transporte-obras-publicas/", "Política sectorial del transporte terrestre y supervisión de la red vial"),
        ("SUCIVE — Sistema Único de Cobro de Ingresos Vehiculares", "https://www.sucive.gub.uy/", "Sistema unificado de cobro de patente de rodados a nivel nacional"),
        ("ANCAP — Administración Nacional de Combustibles, Alcohol y Portland", "https://www.ancap.com.uy/", "Monopolio estatal de combustibles: importación, refinación y comercialización mayorista"),
        ("DGI — Dirección General Impositiva", "https://www.dgi.gub.uy/", "Régimen de comprobantes fiscales electrónicos (CFE) y normativa tributaria"),
        ("BCU — Banco Central del Uruguay", "https://www.bcu.gub.uy/", "Estadísticas económicas, comercio exterior y participación sectorial en el PIB"),
        ("INAC — Instituto Nacional de Carnes", "https://www.inac.uy/", "Datos del sector cárnico de exportación, principal usuario de flota frigorífica"),
    ],
},
...
"republica-dominicana": {
    ...
    "hreflang": "es-419",
    "url": "https://thefleetradar.com/mercados/republica-dominicana/",
    "accent_a": "#ce1126",
    "accent_b": "#002d62",
    "grad_a": "rgba(206,17,38,0.18)",
    "grad_b": "rgba(0,45,98,0.14)",
    "topbar_meta": "Mercado · República Dominicana 🇩🇴",
    "hreflang_code": "es-419",
    "meta_desc": "Panorama de flotas en República Dominicana 2026: INTRANT, Ley 63-17 de Movilidad, DGII, Refidomsa, sectores turismo, cemento, zonas francas y corredor Santo Domingo-Santiago.",
    "og_desc": "Regulación, players y cifras clave del mercado de gestión de flotas en República Dominicana 2026.",
    "schema_desc": "Panorama editorial del mercado de gestión de flotas en República Dominicana 2026: INTRANT, Ley 63-17, turismo, zonas francas y players activos.",
    "deck": "República Dominicana tiene una de las tasas de motorización más altas del Caribe, con cerca de 5 millones de vehículos en un país de 11 millones de habitantes. La Ley 63-17 de Movilidad, Transporte Terrestre, Tránsito y Seguridad Vial creó el INTRANT en 2017 y modernizó el marco regulatorio. El turismo —aeropuertos a resorts— y la construcción son los sectores tractores de la flota.",
    "updated": "24 de mayo de 2026",
    "intro": """<p>República Dominicana ha vivido una reforma regulatoria reciente en transporte: la Ley 63-17 de Movilidad, Transporte Terrestre, Tránsito y Seguridad Vial, aprobada en 2017, creó el INTRANT (Instituto Nacional de Tránsito y Transporte Terrestre) como autoridad unificada y reordenó las competencias antes dispersas entre múltiples instituciones. El proceso de implementación sigue en curso.</p>
    <p>El parque vehicular ronda los 5 millones de unidades, con una tasa de motorización entre las más altas del Caribe. La concentración urbana en el Gran Santo Domingo y Santiago de los Caballeros, sumada al corredor turístico Punta Cana / Bávaro, define la geografía de la flota: turismo (transporte aeropuerto-resort), distribución urbana, construcción y zonas francas.</p>
    <p>El sector construcción —con Cemex y Domicem como cementeras principales— y las zonas francas (textil, dispositivos médicos, electrónica) generan demanda sostenida de flota pesada y de distribución. La industria del ron y tabaco mantienen un componente exportador relevante.</p>""",
    "regulacion": [
        ("Activo", "INTRANT — Instituto Nacional de Tránsito y Transporte Terrestre",
         "Creado por la Ley 63-17 (2017) como autoridad rectora de transporte terrestre, tránsito y seguridad vial. Asumió competencias antes dispersas entre la AMET, la Oficina Técnica de Transporte Terrestre y otros entes. Define normativa, otorga concesiones y regula el sector."),
        ("Activo", "Ley 63-17 — Movilidad, Transporte Terrestre, Tránsito y Seguridad Vial",
         "Marco normativo unificado vigente desde 2017. Establece categorías de licencia, requisitos de empresas de transporte, normas técnicas vehiculares e infracciones. La implementación operativa avanza por fases, con énfasis en seguridad vial y formalización del transporte público."),
        ("Activo", "DGII — Dirección General de Impuestos Internos",
         "Gestiona el régimen tributario incluyendo el ITBIS (impuesto a la transferencia de bienes y servicios) sobre combustibles y servicios de transporte. La factura electrónica (e-CF) avanza en implementación obligatoria por fases para grandes y medianos contribuyentes."),
        ("Activo", "Refidomsa PDV — Refinería Dominicana de Petróleo",
         "Refinería estatal que abastece parte de la demanda nacional de derivados del petróleo. La política de precios de combustibles es revisada semanalmente por el Ministerio de Industria, Comercio y MiPymes (MICM), referencia clave para la planificación de costos de flota."),
        ("soon", "En desarrollo — Reglamentos secundarios de la Ley 63-17",
         "El INTRANT continúa desarrollando reglamentos específicos para transporte de carga, materiales peligrosos y movilidad urbana. La adopción de telemetría sigue siendo voluntaria y concentrada en flotas formales medianas y grandes."),
    ],
    "players": {
        "Combustible y energía": [
            "Sunix · operador local con presencia destacada en red minorista",
            "Texaco · presencia tradicional con red en corredores principales",
            "Shell · red B2B con tarjeta flota",
            "Refidomsa PDV · refinería estatal abastecedora del mercado",
        ],
        "Telemática y GPS": [
            "Geotab · entrada gradual vía distribuidores caribeños",
            "Movitel · proveedor local con cobertura nacional",
            "Track Solutions · solución dominicana para flotas medianas",
            "Samsara · entrada en flotas enterprise",
        ],
        "Renting y servicios": [
            "Magna Motors · concesionario Toyota con servicios de flota",
            "Santo Domingo Motors · BMW y renting corporativo",
            "Avelino Abreu · concesionarios multimarca con postventa de flota",
        ],
        "Fabricantes relevantes": [
            "Toyota · Hilux y Hiace como vehículos dominantes en flota corporativa y turismo",
            "Hyundai · H1 y camiones HD en distribución urbana",
            "Mitsubishi · L200 y Fuso en carga media",
            "Mercedes-Benz · Sprinter en turismo aeropuerto-resort",
            "Foton y JAC · entrada china en carga media y distribución",
        ],
    },
    "fleet_types": [
        ("Turismo aeropuerto-resort", "Punta Cana, Bávaro, La Romana y Puerto Plata como principales polos turísticos. Flotas de Sprinter, Hiace y autobuses operan traslados entre los aeropuertos internacionales (Punta Cana, Las Américas) y los resorts. Operación de altísima estacionalidad."),
        ("Cemento y construcción", "Cemex, Domicem y Cementos Cibao operan flotas de mixers, volquetes y tractores. Demanda sostenida por inversión hotelera y obra pública. Concentración en el Gran Santo Domingo y zonas turísticas en expansión."),
        ("Zonas francas y exportación", "El régimen de zonas francas concentra industrias de textil, dispositivos médicos y electrónica. Flotas de distribución entre parques industriales y puertos (Caucedo, Haina). Conexión crítica con la cadena de exportación a EE.UU."),
        ("Corredor Santo Domingo-Santiago", "Eje logístico principal del país por la Autopista Duarte. Tractocamiones de larga distancia entre la capital y el Cibao. Densidad alta de tráfico mixto carga-pasajeros."),
        ("Distribución urbana y consumo", "Cadenas de supermercados (Jumbo, La Sirena, Bravo), bebidas (Cervecería Nacional Dominicana) y telecomunicaciones con flotas propias de distribución en Santo Domingo y Santiago. Crecimiento en operadores de delivery y e-commerce."),
    ],
    "figures": [
        ("~5M", "vehículos en el parque automotor dominicano, con alta tasa de motorización para la región caribeña", "INTRANT · 2025"),
        ("~16%", "participación estimada del sector transporte y logística en el PIB de República Dominicana", "Banco Central · análisis sectorial"),
        ("#1 Caribe", "Punta Cana es el principal aeropuerto turístico del Caribe por volumen de pasajeros, eje de demanda de flotas de traslado", "JAC / DGAC · 2025"),
        ("2017", "año de creación del INTRANT bajo la Ley 63-17, que unificó el marco regulatorio del transporte terrestre", "INTRANT · 2017"),
    ],
    "related_topics": [
        ("/temas/telematica-flotas-mexico-2026/", "Tema · Referencia", "Telemática para flotas · Referencia LatAm", "Players y benchmarks del sector de telemática aplicables al Caribe."),
        ("/mercados/latam/", "Mercado · Regional", "Flotas en LatAm · Panorama 2026", "Tendencias transversales que impactan al Caribe y Centroamérica."),
        ("/temas/compliance-flotas-mexico-2026/", "Tema · Regulación", "Cumplimiento normativo en flotas", "Metodologías de compliance aplicables al marco de la Ley 63-17."),
    ],
    "editions": [
        ("/magazines/2026-04-20-radar-fleet-by-pulpo.html", "Nº 3 · Flota pesada y tendencias LatAm", "20 abril 2026"),
        ("/magazines/2026-05-11-radar-fleet-by-pulpo.html", "Nº 7 · Tendencias de gestión de flotas", "11 mayo 2026"),
    ],
    "cta_heading": "Pulpo Hub — plataforma con foco en mercados en formalización",
    "cta_body": "República Dominicana avanza en formalizar su sector flotero bajo la Ley 63-17. Pulpo Hub se integra con esquemas de facturación electrónica y control operativo. El equipo puede evaluar adaptación para flotas dominicanas en turismo, construcción y zonas francas.",
    "sources": [
        ("INTRANT — Instituto Nacional de Tránsito y Transporte Terrestre", "https://www.intrant.gob.do/", "Autoridad rectora del transporte terrestre y tránsito bajo la Ley 63-17"),
        ("DGII — Dirección General de Impuestos Internos", "https://dgii.gov.do/", "Régimen tributario, ITBIS sobre combustibles y facturación electrónica (e-CF)"),
        ("MICM — Ministerio de Industria, Comercio y MiPymes", "https://www.micm.gob.do/", "Política de precios de combustibles y regulación del comercio interno"),
        ("Refidomsa PDV — Refinería Dominicana de Petróleo", "https://www.refidomsa.com.do/", "Refinería estatal y abastecedora del mercado de derivados del petróleo"),
        ("Banco Central de la República Dominicana", "https://www.bancentral.gov.do/", "Estadísticas económicas, participación sectorial en el PIB y comercio exterior"),
        ("ONE — Oficina Nacional de Estadística", "https://www.one.gob.do/", "Datos del parque vehicular, movilidad y demografía dominicana"),
    ],
},
